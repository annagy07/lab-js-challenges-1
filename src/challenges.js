...
function howManyTimes(arr, wordSearched) {
  let sumSearchedWord = 0;
  for (let i = 0; i < arr.length; i++) {
    if (arr[i] === wordSearched) {
      sumSearchedWord = sumSearchedWord + 1;
    }
  }
  return sumSearchedWord;
}
...
function filterOut(arr, arrToRemove) {
  ...
  let newArray = [];
  for (let i = 0; i < arr.length; i++) {
    if (arrToRemove.includes(arr[i]) === false) {
      newArray.push(arr[i]);
    }
  }
  return newArray;
...
function uniquifyArray(arr) {
  ...
  let newArrayTwo = [];
  for (let i = 0; i < arr.length; i++) {
    if (newArrayTwo.includes(arr[i]) === false) {
